...
export const pricingPlans: PricingPlan[] = [
  ...
  },
  {
    ...
    usage: ["1 site", "1 SEO crawl per site per month", "Brand mention cards are preview-only"],
  ...
  },
  {
    ...
    tools: [
      ...
      "1 SEO crawl per site per 24 hours",
      "AI recommendations",
      "Expanded Reputation Pulse",
    ],
    usage: ["Up to 10 sites", "1 SEO crawl per site per 24 hours", "Up to 10 brand watch terms"],
